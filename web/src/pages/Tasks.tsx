        ...
        <div className="flex flex-col items-center justify-center w-full h-screen bg-white">
            ...
            <div className="flex flex-col w-5/6 lg:w-1/2 bg-gray-200 rounded-2xl mb-20 p-5">
                <div className="flex">
                    ...
                    <h1 id="dispatcher_id" className="text-svo text-base lg:text-lg ml-1">0</h1>
                </div>
                <div className="flex mt-0.5">
                    <h1 className="text-svo text-base lg:text-lg">Id полёта: </h1>
                    <h1 id="flight_id" className="text-svo text-base lg:text-lg ml-1">0</h1>
                </div>
                <div className="flex mt-0.5">
                    <h1 className="text-svo text-base lg:text-lg">Статус: </h1>
                    <h1 id="status" className="text-svo text-base lg:text-lg ml-1">Не начато</h1>
                </div>
            </div>
